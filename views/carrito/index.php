...
<table>
    ...
    ?>
        <tr>
                ...
                <td>
                <a href="<?=base_url?>carrito/delete&index=<?=$indice?>" class="button button-carrito button-red">Borrar producto</a>
                </td>
        </tr>
    <?php endforeach; ?>
</table>
...
<a href="<?=base_url?>carrito/delete_all" class="button button-delete button-red">Borrar Pedido</a>
</div>
